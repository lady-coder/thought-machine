module "temporal_ui_test_irsa_role" {
  ...
  namespace        = "temporal-ui-test"
  application_name = "temporal-ui"
  role_context     = "test"
}

resource "aws_iam_role_policy_attachment" "temporal_ui_test_appmesh_envoy" {
  role       = module.temporal_ui_test_irsa_role.irsa_role_name
