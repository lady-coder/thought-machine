...
module "customer_cbs_service_irsa_role" {
  ...
  namespace        = "customer-cbs-service"
  application_name = "customer-cbs-service"

}

resource "aws_iam_role_policy_attachment" "customer_cbs_service_appmesh_envoy" {
  role       = module.customer_cbs_service_irsa_role.irsa_role_name
  policy_arn = "arn:aws:iam::aws:policy/AWSAppMeshEnvoyAccess"
}

module "customer_cbs_service_kafka" {
  ...
  policy_prefix    = "customer-cbs-service"
  readwrite_topics = [
