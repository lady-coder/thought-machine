...
module "deposit_balance_service_irsa_role" {
  ...
  namespace        = "deposit-balance-service"
  application_name = "deposit-balance-service"

}

resource "aws_iam_role_policy_attachment" "deposit_balance_service_appmesh_envoy" {
  role       = module.deposit_balance_service_irsa_role.irsa_role_name
  policy_arn = "arn:aws:iam::aws:policy/AWSAppMeshEnvoyAccess"
}

module "deposit_balance_service_kafka" {
  ...
  policy_prefix    = "deposit-balance-service"
  readwrite_topics = [
