...
variable "mwaa_log_groups" {
  description = "MWAA log groups"
  type        = any
  default     = null
}
...
variable "airflow_log_retention_days" {
  description = "Log groups (DAGProcessing, Scheduler, Spark, Task, WebServer, Worker) retention in days"
  type        = number
}
...
variable "datalake_bucket_arns" {
  description = "Datalake bucket arn list"
  type        = list(string)
  default     = []
}

variable "create_secrets_manager_policy" {
  description = "Create policy to read variables and connections from secretsmanager"
  type        = bool
  default     = false
}

variable "airflow_connections_path_prefix" {
  description = "Airflow connections path prefix"
  type        = string
  default     = ""
}

variable "airflow_variables_path_prefix" {
  description = "Airflow variables path prefix"
  type        = string
  default     = ""
}
