...
output "dynamodb_state_file_github_automations_table" {
  value = module.dynamodb_state_file_github_automations.arn
}
...
output "s3_state_file_github_automations_bucket" {
  value = module.s3_state_file_github_automations.bucket_arn
}
